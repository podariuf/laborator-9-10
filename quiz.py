...
def menu():
    ...
    wel = Label(menu_canvas,text=' Bine ati venit la quiz-ul meu',fg="white",bg="#101357") 
    wel.config(font=('Broadway 22'))
    wel.place(relx=0.1,rely=0.02)
    
    
    level = Label(menu_frame,text='Alegeti nivelul de dificultate !!',bg="white",font="calibri 18")
